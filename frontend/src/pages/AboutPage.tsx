      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-blue-100 mb-6 leading-relaxed text-lg">
                ...
                ჩვენ სპეციალიზდებით ხელით დამუშავებულ მეტალის დეკორაციებზე, საბაჟო დიზაინებზე და უნიკალურ ნამუშევრებზე.
              </p>
              <p className="text-blue-100 mb-6 leading-relaxed text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="glassmorphism-card p-8 text-center group hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-blue-100 text-lg leading-relaxed">
              საბაჟო დიზაინები და უნიკალური ნამუშევრები თქვენი იდეების მიხედვით
            </p>
          </div>
          <div className="glassmorphism-card p-8 text-center group hover:scale-105 transition-transform duration-300">
            <div className="text-5xl mb-6 group-hover:scale-110 transition-transform duration-300">🤝</div>
        ...
        <div className="glassmorphism-card p-8 mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="group">
              ...
              <div className="text-blue-200 text-lg font-semibold">საბაჟო შეკვეთები</div>
            </div>
            <div className="group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              <div className="glassmorphism-button p-6 mb-4 group-hover:scale-105 transition-transform duration-300">
                ...
                <h3 className="text-xl font-black text-white mb-2">საბაჟო შეკვეთები</h3>
